...
import com.issever.cryptodiary.databinding.ItemCoinListBinding
import java.util.Locale

class CoinListAdapter : RecyclerView.Adapter<CoinListAdapter.CoinListViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CoinListViewHolder {
        ...
        return CoinListViewHolder(ItemCoinListBinding.inflate(inflater, parent, false))
    }
